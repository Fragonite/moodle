...
class provider implements
     ...
     *
     * Consider an example: exemption courses.
     * exemption courses will be handled by the core_course subsystem and courses can be exempt at site context.
     *
     ...
     *
     * Once called, if a course has been marked as a exemption, at site context, then we'd return the site context. During export,
    ...
    public static function delete_exemptions_for_all_users(\context $context, string $component, string $itemtype,
        ...
        $DB->delete_records_select('exemption', $select, $params);
    }
