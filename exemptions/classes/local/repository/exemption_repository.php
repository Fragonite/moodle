...
/**
 * Contains the exemption_repository class, responsible for CRUD operations for exemptions.
 *
...
class exemption_repository implements exemption_repository_interface {
    ...
    /**
     * Get a exemption object, based on a full record.
     ...
     */
    protected function get_list_of_exemptions_from_records(array $records) {
        $list = [];
    ...
    /**
     * Add a exemption to the repository.
     *
     ...
     *
     * @param array $items the list of exemptions to add.
    ...
    /**
     * Check whether a exemption exists in this repository, based on its id.
     *
