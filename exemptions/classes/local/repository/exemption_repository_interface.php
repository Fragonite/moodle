...
interface exemption_repository_interface {
     ...
     *
     * @param exemption $item the item to add.
     * @return exemption the item which was added.
     */
    public function add(exemption $item): exemption;
     ...
     *
     * @param exemption $item the item to update.
     * @return exemption the updated item.
     */
    public function update(exemption $item): exemption;
