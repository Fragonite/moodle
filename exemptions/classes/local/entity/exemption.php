...
class exemption {
    ...
    /** @var string $itemtype the type of the item being marked as a exemption. E.g. 'course', 'conversation', etc.*/
    public $itemtype;

    /** @var int $itemid the id of the item that is being marked as a exemption. e.g course->id, conversation->id, etc.*/
    public $itemid;
     ...
     */
    public function __construct(string $component, string $itemtype, int $itemid, int $contextid, ?string $reason = null, ?int $reasonformat = null, ?int $usermodified = null) {
        global $USER;
